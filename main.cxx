...
void runExperiment(const G& x) {
  ...
  for (float insertionsf=1e-4; insertionsf<=0.1; insertionsf*=10) {
    ...
    glog(p0, "predictLinksJaccardCoefficientOmp", numThreads, insertionsf, insertions0, insertions0, insertions0);
    {
      ...
      auto p1 = predictLinksJaccardCoefficientOmp<2>(x, {repeat, insertionsc});
    ...
    {
      // Predict links using Modified Jaccard's coefficient.
      auto p1 = predictLinksJaccardCoefficientOmp<4>(x, {repeat, insertionsc});
      vector<tuple<K, K, V>> insertions1 = directedInsertions(p1.edges, V(1), true);
      sort(insertions1.begin(), insertions1.end());
      vector<tuple<K, K, V>> common1 = commonEdges(insertions0, insertions1);
    ...
    {
      // Predict links using Modified Jaccard's coefficient.
      auto p1 = predictLinksJaccardCoefficientOmp<8>(x, {repeat, insertionsc});
      vector<tuple<K, K, V>> insertions1 = directedInsertions(p1.edges, V(1), true);
      sort(insertions1.begin(), insertions1.end());
      vector<tuple<K, K, V>> common1 = commonEdges(insertions0, insertions1);
    ...
    {
      // Predict links using Modified Jaccard's coefficient.
      auto p1 = predictLinksJaccardCoefficientOmp<16>(x, {repeat, insertionsc});
      vector<tuple<K, K, V>> insertions1 = directedInsertions(p1.edges, V(1), true);
      sort(insertions1.begin(), insertions1.end());
      vector<tuple<K, K, V>> common1 = commonEdges(insertions0, insertions1);
    ...
    {
      // Predict links using Modified Jaccard's coefficient.
      auto p1 = predictLinksJaccardCoefficientOmp<32>(x, {repeat, insertionsc});
      vector<tuple<K, K, V>> insertions1 = directedInsertions(p1.edges, V(1), true);
      sort(insertions1.begin(), insertions1.end());
      vector<tuple<K, K, V>> common1 = commonEdges(insertions0, insertions1);
    ...
    {
      // Predict links using Modified Jaccard's coefficient.
      auto p1 = predictLinksJaccardCoefficientOmp<64>(x, {repeat, insertionsc});
      vector<tuple<K, K, V>> insertions1 = directedInsertions(p1.edges, V(1), true);
      sort(insertions1.begin(), insertions1.end());
      vector<tuple<K, K, V>> common1 = commonEdges(insertions0, insertions1);
