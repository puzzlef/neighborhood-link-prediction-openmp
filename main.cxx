...
void runExperiment(const G& x) {
  ...
  runBatches(x, rnd, [&](const auto& y, auto deletionsf, const auto& deletions, auto insertionsf, const auto& insertions, int sequence, int epoch) {
    ...
    PREDICT_LINKS(y, predictLinksCommonNeighborsOmp,          32, deletionsf, deletions0);
    ...
    PREDICT_LINKS(y, predictLinksAdamicAdarCoefficientOmp,    32, deletionsf, deletions0);
    PREDICT_LINKS(y, predictLinksResourceAllocationScoreOmp, 256, deletionsf, deletions0);
  });
}
